...
#         }
#
#     append_message_list(PROMPT_MESSAGE)
#     agents = st.session_state['reflection_agents']
#     agents_response = (recipient=agents.prompter_agent, message=PROMPT_MESSAGE,
#                                                             max_turns=2,
#                                                             summary_method="last_msg")
#     content = agents_response.chat_history[0].get("content")
